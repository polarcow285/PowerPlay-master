...
@Autonomous
public class RegionalsAutoNoLift extends LinearOpMode {
...
//         * This REPLACES waitForStart!
        ...
        if (tagOfInterest == null || tagOfInterest.id == LEFT) {
            encoderDrive (0.3, 900,900,900,900);
            stop(500);
            turnToHeading(TURN_SPEED, 90.0);
            stop(500);
            encoderDrive (0.3, 775,775,775,775);
            stop(500);
        }
            ...
            encoderDrive (0.3, 850,850,850,850);
            stop(500);
            turnToHeading(TURN_SPEED, -90.0);
            stop(500);
            encoderDrive (0.3, 825,825,825,825);
            stop(500);
        }
